...
var P = (e, t, n) => (al(e, t, "read from private field"),
n ? n.call(e) : t.get(e))
...
n)
  , be = (e, t, n) => (al(e, t, "access private method"),
n);
var pi = (e, t, n, r) => ({
    set _(o) {
        B(e, t, o, n)
...
var Dg = w
  ...
  , $g = Dg.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner
  , Ug = {
    key: !0,
    ref: !0,
    __self: !0,
...
var Ht = !(typeof window > "u" || typeof window.document > "u" || typeof window.document.createElement > "u")
  ...
  , Sc = {};
function Wg(e) {
    return Bl.call(Sc, e) ? !0 : Bl.call(xc, e) ? !1 : Hg.test(e) ? Sc[e] = !0 : (xc[e] = !0,
    !1)
}
function Qg(e, t, n, r) {
    if (n !== null && n.type === 0)
...
function Yl(e, t) {
    ...
    t.hasOwnProperty("value") ? Gl(e, t.type, n) : t.hasOwnProperty("defaultValue") && Gl(e, t.type, Nn(t.defaultValue)),
...
var Zf = qe.unstable_scheduleCallback
  , Rc = qe.unstable_cancelCallback
  , ov = qe.unstable_shouldYield
  , iv = qe.unstable_requestPaint
  , pe = qe.unstable_now
  , sv = qe.unstable_getCurrentPriorityLevel
  , uu = qe.unstable_ImmediatePriority
  , Jf = qe.unstable_UserBlockingPriority
  , es = qe.unstable_NormalPriority
  , lv = qe.unstable_LowPriority
  , ep = qe.unstable_IdlePriority
  , js = null
  , Ot = null;
function av(e) {
...
var rp, du, op, ip, sp, ia = !1, xi = [], xn = null, Sn = null, En = null, Do = new Map, Io = new Map, cn = [], mv = "mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset submit".split(" ");
function jc(e, t) {
    switch (e) {
    case "focusin":
    case "focusout":
...
function fo(e, t) {
    ...
    ia || (ia = !0,
    qe.unstable_scheduleCallback(qe.unstable_NormalPriority, vv)))
}
function zo(e) {
    function t(o) {
        return fo(o, e)
...
function up() {
    if (Fi)
        return Fi;
    var e, t = pu, n = t.length, r, o = "value"in vn ? vn.value : vn.textContent, i = o.length;
...
var Mv = ce({}, oi, {
    key: function(e) {
        ...
        e === 13 ? "Enter" : String.fromCharCode(e)) : e.type === "keydown" || e.type === "keyup" ? jv[e.keyCode] || "Unidentified" : ""
    },
    code: 0,
    location: 0,
    ctrlKey: 0,
  ...
  , Uv = Ze($v)
  , Bv = [9, 13, 27, 32]
  , gu = Ht && "CompositionEvent"in window
  , bo = null;
Ht && "documentMode"in document && (bo = document.documentMode);
var Vv = Ht && "TextEvent"in window && !bo
  , cp = Ht && (!gu || bo && 8 < bo && 11 >= bo)
  , Dc = " "
  , Ic = !1;
function dp(e, t) {
    switch (e) {
...
function $c() {
    Po && (Po.detachEvent("onpropertychange", mp),
    Fo = Po = null)
}
function mp(e) {
...
function Gv(e, t, n) {
    ...
    Po = t,
    Fo = n,
    Po.attachEvent("onpropertychange", mp)) : e === "focusout" && $c()
}
function qv(e) {
...
var St = typeof Object.is == "function" ? Object.is : Jv;
function $o(e, t) {
    if (St(e, t))
        return !0;
...
var xr = {
  ...
  , xl = {}
  , yp = {};
Ht && (yp = document.createElement("div").style,
...
var wp = Ms("animationend")
  , xp = Ms("animationiteration")
  , Sp = Ms("animationstart")
  , Ep = Ms("transitionend")
  , Cp = new Map
...
for (var Sl = 0; Sl < Hc.length; Sl++) {
    var El = Hc[Sl]
      , ny = El.toLowerCase()
      , ry = El[0].toUpperCase() + El.slice(1);
    Dn(ny, "on" + ry)
}
Dn(wp, "onAnimationEnd");
Dn(xp, "onAnimationIteration");
Dn(Sp, "onAnimationStart");
...
var Eo = "abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange resize seeked seeking stalled suspend timeupdate volumechange waiting".split(" ")
  , oy = new Set("cancel close invalid load scroll toggle".split(" ").concat(Eo));
function Wc(e, t, n) {
...
function Uo(e) {
    if (!e[Ci]) {
        ...
        _f.forEach(function(n) {
            n !== "selectionchange" && (oy.has(n) || Cl(n, !1, e),
            Cl(n, !0, e))
        });
    ...
    Yf(function() {
        ...
        if (!(t & 7)) {
            e: {
                ...
                h && n !== ea && (x = n.relatedTarget || n.fromElement) && (Hn(x) || x[Wt]))
                    break e;
                ...
                d !== x)) {
                    ...
                    h.relatedTarget = g,
                    E = null,
                    Hn(c) === u && (v = new v(m,p + "enter",x,n,c),
                    v.target = g,
                    v.relatedTarget = y,
                    E = v),
                    y = E,
            ...
            e: {
                ...
                d === "select" || d === "input" && h.type === "file")
                    ...
                    (d = h.nodeName) && d.toLowerCase() === "input" && (h.type === "checkbox" || h.type === "radio") && (C = Xv);
                if (C && (C = C(e, u))) {
                    pp(f, C, n, c);
                    break e
                }
            ...
            R && (cp && n.locale !== "ko" && (yr || R !== "onCompositionStart" ? R === "onCompositionEnd" && yr && (b = up()) : (vn = c,
            ...
            b ? R.data = b : (b = fp(n),
            b !== null && (R.data = b)))),
            (b = Vv ? Hv(e, n) : Wv(e, n)) && (u = os(u, "onBeforeInput"),
...
var no = Math.random().toString(36).slice(2)
  , jt = "__reactFiber$" + no
  , Vo = "__reactProps$" + no
  , Wt = "__reactContainer$" + no
  , pa = "__reactEvents$" + no
  , cy = "__reactListeners$" + no
  , dy = "__reactHandles$" + no;
function Hn(e) {
    var t = e[jt];
    if (t)
        return t;
...
function Pp(e, t, n) {
    ...
    for (var o in r)
        if (!(o in t))
            throw Error(j(108, Gg(e) || "Unknown", o));
    return ce({}, n, r)
}
function ls(e) {
...
function Op(e) {
    ...
    function l(m, p, g, E) {
        return p === null || p.tag !== 6 ? (p = Ml(g, m.mode, E),
        p.return = m,
        p) : (p = o(p, g),
        p.return = m,
        p)
    ...
    function a(m, p, g, E) {
        var C = g.type;
        return C === vr ? c(m, p, g.props.children, E, g.key) : p !== null && (p.elementType === C || typeof C == "object" && C !== null && C.$$typeof === an && ed(C) === p.type) ? (E = o(p, g.props),
        E.ref = ho(m, p, g),
        E.return = m,
    ...
    function x(m, p, g, E) {
        for (var C = null, k = null, b = p, R = p = 0, M = null; b !== null && R < g.length; R++) {
            b.index > R ? (M = b,
            b = null) : M = b.sibling;
            var _ = h(m, b, g[R], E);
            if (_ === null) {
        ...
        for (b = r(m, b); R < g.length; R++)
            M = d(b, m, R, g[R], E),
            M !== null && (e && M.alternate !== null && b.delete(M.key === null ? R : M.key),
            p = i(M, p, R),
    ...
    function v(m, p, g, E) {
        ...
        g == null)
            throw Error(j(151));
        for (var k = C = null, b = p, R = p = 0, M = null, _ = g.next(); b !== null && !_.done; R++,
        _ = g.next()) {
            b.index > R ? (M = b,
            b = null) : M = b.sibling;
        ...
        for (b = r(m, b); !_.done; R++,
        _ = g.next())
            _ = d(b, m, R, _.value, E),
            _ !== null && (e && _.alternate !== null && b.delete(_.key === null ? R : _.key),
            p = i(_, p, R),
            k === null ? C = _ : k.sibling = _,
            k = _);
                ...
                e: {
                    for (var C = g.key, k = p; k !== null; ) {
                        if (k.key === C) {
                            ...
                            } else if (k.elementType === C || typeof C == "object" && C !== null && C.$$typeof === an && ed(C) === k.type) {
                                n(m, k.sibling),
                                p = o(k, g.props),
                                p.ref = ho(m, k, g),
                                p.return = m,
...
function th(e, t, n) {
    var r = !1
      , o = Rn
      , i = t.contextType;
    return typeof i == "object" && i !== null ? i = st(i) : (o = Ue(t) ? tr : je.current,
    r = t.contextTypes,
...
function wa(e, t, n, r) {
    ...
    bu(e);
    var i = t.contextType;
    typeof i == "object" && i !== null ? o.context = st(i) : (i = Ue(t) ? tr : je.current,
    o.context = Qr(e, i)),
    o.state = e.memoizedState,
...
function fd(e, t, n, r, o) {
    ...
    t.stateNode === null)
        ...
        var a = s.context
          , u = n.contextType;
        typeof u == "object" && u !== null ? u = st(u) : (u = Ue(n) ? tr : je.current,
        u = Qr(t, u));
        ...
        a = t.memoizedState),
        (l = un || id(t, n, l, r, h, a, u)) ? (f || typeof s.UNSAFE_componentWillMount != "function" && typeof s.componentWillMount != "function" || (typeof s.componentWillMount == "function" && s.componentWillMount(),
        ...
        h = s.context,
        a = n.contextType,
        typeof a == "object" && a !== null ? a = st(a) : (a = Ue(n) ? tr : je.current,
        a = Qr(t, a));
        ...
        x = t.memoizedState),
        (u = un || id(t, n, u, r, h, x, a) || !1) ? (c || typeof s.UNSAFE_componentWillUpdate != "function" && typeof s.componentWillUpdate != "function" || (typeof s.componentWillUpdate == "function" && s.componentWillUpdate(r, x, a),
...
function Ea(e, t, n, r, o, i) {
    ...
    t.child = Yr(t, null, l, i)) : _e(e, t, l, i),
                ...
                e: {
                    ...
                    for (i in l)
                        if (l.hasOwnProperty(i)) {
                            ...
                            a != null && Uf(e, a)) : i === "children" ? typeof a == "string" ? (n !== "textarea" || a !== "") && Ao(e, a) : typeof a == "number" && Ao(e, "" + a) : i !== "suppressContentEditableWarning" && i !== "suppressHydrationWarning" && i !== "autoFocus" && (Mo.hasOwnProperty(i) ? a != null && i === "onScroll" && oe("scroll", e) : a != null && ou(e, i, a, s))
                        }
                    switch (n) {
                    case "input":
                        gi(e),
            ...
            a !== null)
                try {
                    ...
                    for (s = 0; s < a.length; s += 2) {
                        var c = a[s]
                          , f = a[s + 1];
                        c === "style" ? Vf(o, f) : c === "dangerouslySetInnerHTML" ? Uf(o, f) : c === "children" ? Ao(o, f) : ou(o, c, f, u)
                    }
                    switch (l) {
                    case "input":
                        Yl(o, i);
...
function Pn(e) {
    return e.mode & 1 ? X & 2 && Ee !== 0 ? Ee & -Ee : py.transition !== null ? (Qi === 0 && (Qi = tp()),
    Qi) : (e = ee,
    e !== 0 || (e = window.event,
...
function Be(e, t) {
    ...
    e.callbackPriority !== t) {
        if (n != null && Rc(n),
        t === 1)
            e.tag === 0 ? fy(Sd.bind(null, e)) : Tp(Sd.bind(null, e)),
            ay(function() {
                !(X & 6) && zn()
            }),
            n = null;
        ...
        if (t === 6)
            ...
            case 3:
                ...
                10 < t)) {
                    ...
                    e.timeoutHandle = fa(Vn.bind(null, e, ze, zt), t);
                    break
                }
                Vn(e, ze, zt);
                break;
            case 4:
                ...
                if (r = o,
                r = pe() - r,
                r = (120 > r ? 120 : 480 > r ? 480 : 1080 > r ? 1080 : 1920 > r ? 1920 : 3e3 > r ? 3e3 : 4320 > r ? 4320 : 1960 * jy(r / 1960)) - r,
                10 < r) {
                    e.timeoutHandle = fa(Vn.bind(null, e, ze, zt), r);
                    break
                }
                Vn(e, ze, zt);
                break;
...
function $u() {
    (ye === 0 || ye === 3 || ye === 2) && (ye = 4),
    xe === null || !(or & 268435455) && !(Fs & 268435455) || dn(xe, Ee)
}
function ws(e, t) {
    var n = X;
    X |= 2;
...
kh = function(e, t, n) {
    ...
    case 4:
        ...
        r = t.pendingProps,
        e === null ? t.child = Yr(t, null, r, n) : _e(e, t, r, n),
        t.child;
    case 11:
        return r = t.type,
        o = t.pendingProps,
...
Bs.prototype.render = Hu.prototype.render = function(e) {
...
;
Bs.prototype.unmount = Hu.prototype.unmount = function() {
...
function Vy(e, t, n, r, o) {
    ...
    var a = Bu(e, 0, !1, null, null, !1, !1, "", kd);
...
var Hy = {
  ...
  , Wy = {
    ...
    findFiberByHostInstance: go.findFiberByHostInstance || By,
...
Xe.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Hy;
...
function Jy(e) {
    const t = w.forwardRef( (n, r) => {
        ...
        if (w.isValidElement(o)) {
            const s = r0(o)
              , l = n0(i, o.props);
            return o.type !== w.Fragment && (l.ref = r ? Mh(r, s) : s),
            w.cloneElement(o, l)
        }
...
var l0 = "DismissableLayer", Aa = "dismissableLayer.update", a0 = "dismissableLayer.pointerDownOutside", u0 = "dismissableLayer.focusOutside", Nd, Dh = w.createContext({
    layers: new Set,
    ...
    const {disableOutsidePointerEvents: n=!1, onEscapeKeyDown: r, onPointerDownOutside: o, onFocusOutside: i, onInteractOutside: s, onDismiss: l, ...a} = e
      ...
      , C = d0(b => {
        const R = b.target
          , M = [...u.branches].some(_ => _.contains(R));
        !E || M || (o == null || o(b),
        s == null || s(b),
    ...
    , h)
      , k = f0(b => {
        const R = b.target;
        [...u.branches].some(_ => _.contains(R)) || (i == null || i(b),
        s == null || s(b),
        b.defaultPrevented || l == null || l())
    }
    , h);
    ...
    w.useEffect( () => {
        const b = () => d({});
        return document.addEventListener(Aa, b),
        () => document.removeEventListener(Aa, b)
    }
    , []),
    S.jsx(He.div, {
        ...a,
...
var p0 = Qu
  , h0 = Ih
  , On = globalThis != null && globalThis.document ? w.useLayoutEffect : () => {}
  , m0 = "Portal"
  , Fh = w.forwardRef( (e, t) => {
    var l;
    ...
    return s ? jh.createPortal(S.jsx(He.div, {
        ...r,
        ref: t
    }), s) : null
}
...
var w0 = Tf[" useInsertionEffect ".trim().toString()] || On;
...
var C0 = Object.freeze({
  ...
  , k0 = "VisuallyHidden"
  , Qs = w.forwardRef( (e, t) => S.jsx(He.span, {
    ...e,
    ref: t,
    style: {
        ...C0,
            ...
            const m = p => {
                ...
                if (p.key === "Tab" && !g) {
                    ...
                    const I = v({
                      ...
                      , Q = I.findIndex(A => A === R);
                    Il(I.slice(Q + 1)) ? p.preventDefault() : M ? (k = u.current) == null || k.focus() : (b = c.current) == null || b.focus()
                }
            }
            ;
  ...
  , D0 = w.forwardRef( (e, t) => {
    const {__scopeToast: n, type: r="foreground", duration: o, open: i, onClose: s, onEscapeKeyDown: l, onPause: a, onResume: u, onSwipeStart: c, onSwipeMove: f, onSwipeCancel: h, onSwipeEnd: d, ...x} = e
      ...
      , I = w.useCallback(A => {
        ...
        R.current = window.setTimeout(F, A))
    }
    , [F]);
    w.useEffect( () => {
        const A = v.viewport;
        if (A) {
            ...
            ;
            return A.addEventListener(La, $),
            A.addEventListener(Da, q),
            () => {
                A.removeEventListener(La, $),
                A.removeEventListener(Da, q)
            }
        }
    }
    , [v.viewport, C, a, u, I]),
                ...
                children: S.jsx(p0, {
                    ...
                    children: S.jsx(He.li, {
                        ...
                        onPointerMove: ve(e.onPointerMove, A => {
                            ...
                            _i(O0, f, G, {
                                discrete: !1
                            })) : jd(K, v.swipeDirection, z) ? (E.current = K,
                            _i(j0, c, G, {
                                discrete: !1
                            }),
                            A.target.setPointerCapture(A.pointerId)) : (Math.abs(q) > z || Math.abs($) > z) && (g.current = null)
                        }
                        ),
                        onPointerUp: ve(e.onPointerUp, A => {
                            ...
                            q) {
                                ...
                                jd(q, v.swipeDirection, v.swipeThreshold) ? _i(M0, d, T, {
                                    discrete: !0
                                }) : _i(_0, h, T, {
                                    discrete: !0
                                }),
...
var Yh = "ToastAction"
  , Gh = w.forwardRef( (e, t) => {
    ...
    }) : (console.error(`Invalid prop \`altText\` supplied to \`${Yh}\`. Expected non-empty \`string\`.`),
    null)
}
);
Gh.displayName = Yh;
...
const H0 = e => e.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase()
  , am = (...e) => e.filter( (t, n, r) => !!t && t.trim() !== "" && r.indexOf(t) === n).join(" ").trim();
/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const Q0 = w.forwardRef( ({color: e="currentColor", size: t=24, strokeWidth: n=2, absoluteStrokeWidth: r, className: o="", children: i, iconNode: s, ...l}, a) => w.createElement("svg", {
    ref: a,
    ...W0,
    width: t,
    height: t,
 ...
 */
const Je = (e, t) => {
    const n = w.forwardRef( ({className: r, ...o}, i) => w.createElement(Q0, {
        ref: i,
        iconNode: t,
        className: am(`lucide-${H0(e)}`, r),
        ...o
    }));
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const G0 = Je("ClipboardList", [["rect", {
    width: "8",
    height: "4",
    x: "8",
    y: "2",
  ...
  , L1 = () => {
    ...
    return {
        ...
        theme: {
            ...
            gradientColorStopPositions: [b1, on],
            inset: F(),
            margin: F(),
            opacity: V(),
            padding: I(),
...
const I1 = V0
  , mm = w.forwardRef( ({className: e, ...t}, n) => S.jsx(Jh, {
    ref: n,
    className: At("fixed top-0 z-[100] flex max-h-screen w-full flex-col-reverse p-4 sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col md:max-w-[420px]", e),
    ...t
}));
mm.displayName = Jh.displayName;
const z1 = lm("group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-md border p-6 pr-8 shadow-lg transition-all data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-[var(--radix-toast-swipe-end-x)] data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=move]:transition-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-right-full data-[state=open]:slide-in-from-top-full data-[state=open]:sm:slide-in-from-bottom-full", {
    variants: {
        variant: {
  ...
  , gm = w.forwardRef( ({className: e, variant: t, ...n}, r) => S.jsx(em, {
    ref: r,
    className: At(z1({
        variant: t
    }), e),
...
const F1 = w.forwardRef( ({className: e, ...t}, n) => S.jsx(rm, {
    ref: n,
    className: At("inline-flex h-8 shrink-0 items-center justify-center rounded-md border bg-transparent px-3 text-sm font-medium ring-offset-background transition-colors group-[.destructive]:border-muted/40 hover:bg-secondary group-[.destructive]:hover:border-destructive/30 group-[.destructive]:hover:bg-destructive group-[.destructive]:hover:text-destructive-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 group-[.destructive]:focus:ring-destructive disabled:pointer-events-none disabled:opacity-50", e),
    ...t
}));
F1.displayName = rm.displayName;
const vm = w.forwardRef( ({className: e, ...t}, n) => S.jsx(om, {
    ref: n,
    className: At("absolute right-2 top-2 rounded-md p-1 text-foreground/50 opacity-0 transition-opacity group-hover:opacity-100 group-[.destructive]:text-red-300 hover:text-foreground group-[.destructive]:hover:text-red-50 focus:opacity-100 focus:outline-none focus:ring-2 group-[.destructive]:focus:ring-red-400 group-[.destructive]:focus:ring-offset-red-600", e),
    "toast-close": "",
    ...t,
    children: S.jsx(um, {
        className: "h-4 w-4"
...
vm.displayName = om.displayName;
const ym = w.forwardRef( ({className: e, ...t}, n) => S.jsx(tm, {
    ref: n,
    className: At("text-sm font-semibold", e),
    ...t
}));
ym.displayName = tm.displayName;
const wm = w.forwardRef( ({className: e, ...t}, n) => S.jsx(nm, {
    ref: n,
...
var Ld = ["light", "dark"]
  ...
  , H1 = () => {
    var e;
    return (e = w.useContext(B1)) != null ? e : V1
}
;
    ...
    let u = i === "system"
      ...
      , h = (x, v=!1, y=!0) => {
        let m = s ? s[x] : x
          , p = v ? x + "|| ''" : `'${m}'`
          , g = "";
        return o && y && !v && Ld.includes(x) && (g += `d.style.colorScheme = '${x}';`),
        n === "class" ? v || m ? g += `c.add(${p})` : g += "null" : m && (g += `d[s](n,${p})`),
        g
    }
      , d = e ? `!function(){${c}${h(e)}}()` : r ? `!function(){try{${c}var e=localStorage.getItem('${t}');if('system'===e||(!e&&${u})){var t='${U1}',m=window.matchMedia(t);if(m.media!==t||m.matches){${h("dark")}}else{${h("light")}}}else if(e){${s ? `var x=${JSON.stringify(s)};` : ""}${h(s ? "x[e]" : "e", !0)}}${u ? "" : "else{" + h(i, !1, !1) + "}"}${f}}catch(e){}}()` : `!function(){try{${c}var e=localStorage.getItem('${t}');if(e){${s ? `var x=${JSON.stringify(s)};` : ""}${h(s ? "x[e]" : "e", !0)}}else{${h(i, !1, !1)};}${f}}catch(t){}}();`;
...
var W1 = e => {
...
}, Q1.map( (n, r) => O.createElement("div", {
  ...
  , nw = e => e && typeof e == "object" && "ok"in e && typeof e.ok == "boolean" && "status"in e && typeof e.status == "number"
  , rw = tw
  , ow = () => Ie.toasts
  , iw = () => Ie.getActiveToasts();
Object.assign(rw, {
    success: Ie.success,
    info: Ie.info,
    warning: Ie.warning,
...
var mw = e => {
    ...
    let {invert: h, toast: d, unstyled: x, interacting: v, setHeights: y, visibleToasts: m, heights: p, index: g, toasts: E, expanded: C, removeToast: k, defaultRichColors: b, closeButton: R, style: M, cancelButtonStyle: _, actionButtonStyle: F, className: I="", descriptionClassName: Q="", duration: A, position: q, gap: $, loadingIcon: H, expandByDefault: T, classNames: N, icons: L, closeButtonAriaLabel: V="Close toast", pauseWhenPageIsHidden: z} = e
      , [K,G] = O.useState(null)
    ...
    , [d.closeButton, R])
      , fc = O.useMemo( () => d.duration || A || Dd, [d.duration, A])
      , sl = O.useRef(0)
      , pr = O.useRef(0)
      , pc = O.useRef(0)
      , hr = O.useRef(null)
      , [gg,vg] = q.split("-")
      , hc = O.useMemo( () => p.reduce( (U, te, se) => se >= fi ? U : U + te.height, 0), [p, fi])
      , mc = J1()
      , yg = d.invert || h
      , ll = et === "loading";
    ...
    return O.createElement("li", {
        tabIndex: 0,
        ref: $n,
        className: ft(I, pg, N == null ? void 0 : N.toast, (t = d == null ? void 0 : d.classNames) == null ? void 0 : t.toast, N == null ? void 0 : N.default, N == null ? void 0 : N[et], (n = d == null ? void 0 : d.classNames) == null ? void 0 : n[et]),
        "data-sonner-toast": "",
        ...
        onPointerUp: () => {
            ...
            let ut = Number(((U = $n.current) == null ? void 0 : U.style.getPropertyValue("--swipe-amount-x").replace("px", "")) || 0)
              , tn = Number(((te = $n.current) == null ? void 0 : te.style.getPropertyValue("--swipe-amount-y").replace("px", "")) || 0)
              , Un = new Date().getTime() - ((se = dc.current) == null ? void 0 : se.getTime())
              , ct = K === "x" ? ut : tn
              , nn = Math.abs(ct) / Un;
            if (Math.abs(ct) >= fw || nn > .11) {
                so(pr.current),
        ...
        onPointerMove: U => {
            ...
            if (!hr.current || !fr || ((te = window.getSelection()) == null ? void 0 : te.toString().length) > 0)
                return;
            let tn = U.clientY - hr.current.y
              , Un = U.clientX - hr.current.x
              , ct = (se = e.swipeDirections) != null ? se : hw(q);
            ...
            (at = $n.current) == null || at.style.setProperty("--swipe-amount-x", `${nn.x}px`),
            (ut = $n.current) == null || ut.style.setProperty("--swipe-amount-y", `${nn.y}px`)
        }
    }, mg && !d.jsx ? O.createElement("button", {
        "aria-label": V,
        "data-disabled": ll,
        "data-close-button": !0,
        onClick: ll || !fr ? () => {}
    ...
    }, (i = L == null ? void 0 : L.close) != null ? i : Z1) : null, d.jsx || w.isValidElement(d.title) ? d.jsx ? d.jsx : typeof d.title == "function" ? d.title() : d.title : O.createElement(O.Fragment, null, et || d.icon || d.promise ? O.createElement("div", {
        "data-icon": "",
        className: ft(N == null ? void 0 : N.icon, (s = d == null ? void 0 : d.classNames) == null ? void 0 : s.icon)
    }, d.promise || d.type === "loading" && !d.icon ? d.icon || wg() : null, d.type !== "loading" ? d.icon || (L == null ? void 0 : L[et]) || W1(et) : null) : null, O.createElement("div", {
        "data-content": "",
        ...
        "data-description": "",
        className: ft(Q, hg, N == null ? void 0 : N.description, (u = d == null ? void 0 : d.classNames) == null ? void 0 : u.description)
    }, typeof d.description == "function" ? d.description() : d.description) : null), w.isValidElement(d.cancel) ? d.cancel : d.cancel && Mi(d.cancel) ? O.createElement("button", {
        "data-button": !0,
        "data-cancel": !0,
        style: d.cancelButtonStyle || _,
        onClick: U => {
            var te, se;
            Mi(d.cancel) && fr && ((se = (te = d.cancel).onClick) == null || se.call(te, U),
            en())
        }
        ,
        className: ft(N == null ? void 0 : N.cancelButton, (c = d == null ? void 0 : d.classNames) == null ? void 0 : c.cancelButton)
    }, d.cancel.label) : null, w.isValidElement(d.action) ? d.action : d.action && Mi(d.action) ? O.createElement("button", {
        "data-button": !0,
        "data-action": !0,
...
var vw = w.forwardRef(function(e, t) {
    let {invert: n, position: r="bottom-right", hotkey: o=["altKey", "KeyT"], expand: i, closeButton: s, className: l, offset: a, mobileOffset: u, theme: c="light", richColors: f, duration: h, style: d, visibleToasts: x=lw, toastOptions: v, dir: y=Id(), gap: m=dw, loadingIcon: p, icons: g, containerAriaLabel: E="Notifications", pauseWhenPageIsHidden: C} = e
      , [k,b] = O.useState([])
      , R = O.useMemo( () => Array.from(new Set([r].concat(k.filter(z => z.position).map(z => z.position)))), [k, r])
      , [M,_] = O.useState([])
      , [F,I] = O.useState(!1)
      , [Q,A] = O.useState(!1)
      , [q,$] = O.useState(c !== "system" ? c : typeof window < "u" && window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light")
      , H = O.useRef(null)
...
const Nw = e => ({
    ...
    async fn(t) {
        ...
        const R = E / 2 - C / 2
          ...
          , A = b / 2 - v[x] / 2 + R
          , q = $a(I, A, Q)
          , $ = !a.arrow && oo(o) != null && A !== q && i.reference[x] / 2 - (A < I ? _ : F) - v[x] / 2 < 0
          , H = $ ? A < I ? A - I : A - Q : 0;
        return {
            [d]: h[d] + H,
            data: {
    ...
    return e === void 0 && (e = {}),
    {
        ...
        async fn(t) {
            ...
            const {placement: o, middlewareData: i, rects: s, initialPlacement: l, platform: a, elements: u} = t
              , {mainAxis: c=!0, crossAxis: f=!0, fallbackPlacements: h, fallbackStrategy: d="bestFit", fallbackAxisSideDirection: x="none", flipAlignment: v=!0, ...y} = Yt(e, t);
            ...
            !M.every(A => A <= 0)) {
                ...
                let $ = (I = _.filter(H => H.overflows[0] <= 0).sort( (H, T) => H.overflows[1] - T.overflows[1])[0]) == null ? void 0 : I.placement;
                if (!$)
                    switch (d) {
                    case "bestFit":
                        {
                            var Q;
                            const H = (Q = _.filter(T => {
                                if (k) {
        ...
        async fn(t) {
            ...
            k && !h) {
                const _ = Qe(c.left, 0)
                  ...
                  , I = Qe(c.top, 0)
                  , Q = Qe(c.bottom, 0);
                d ? R = x - 2 * (_ !== 0 || F !== 0 ? _ + F : Qe(c.left, c.right)) : b = v - 2 * (I !== 0 || Q !== 0 ? I + Q : Qe(c.top, c.bottom))
            }
            await a({
                ...t,
                availableWidth: R,
...
function Ln(e) {
    if (io(e) === "html")
        return e;
    const t = e.assignedSlot || e.parentNode || Ud(e) && e.host || Lt(e);
    return Ud(t) ? t.host : t
}
function Em(e) {
    const t = Ln(e);
    return Zr(t) ? e.ownerDocument ? e.ownerDocument.body : e.body : Mt(t) && ui(t) ? t : Em(t)
}
function Xo(e, t, n) {
    var r;
    t === void 0 && (t = []),
...
function bm(e, t) {
    const n = Ln(e);
    return n === t || !Ct(n) || Zr(n) ? !1 : kt(n).position === "fixed" || bm(n, t)
}
function Ww(e, t) {
    const n = t.get(e);
    if (n)
        return n;
    let r = Xo(e, [], !1).filter(l => Ct(l) && io(l) !== "body")
      , o = null;
    ...
    for (; Ct(s) && !Zr(s); ) {
        ...
        (i ? !a && !o : !a && l.position === "static" && !!o && ["absolute", "fixed"].includes(o.position) || ui(s) && !a && bm(e, s)) ? r = r.filter(c => c !== s) : o = l,
        s = Ln(s)
    }
    return t.set(e, r),
    r
...
function Qw(e) {
    ...
    const s = [...n === "clippingAncestors" ? Gs(t) ? [] : Ww(t, this._c) : [].concat(n), r]
      , l = s[0]
      , a = s.reduce( (u, c) => {
        const f = Bd(t, c, o);
...
function Pm(e, t) {
    ...
    for (; r && Dw(r) && Fl(r); )
        r = Vd(r, t);
    return r && Zr(r) && Fl(r) && !tc(r) ? n : r || Iw(e) || n
}
...
function Zw(e, t) {
    ...
    function s(l, a) {
        ...
        !f || !h)
            return;
        const d = Ai(c)
          , x = Ai(o.clientWidth - (u + f))
          , v = Ai(o.clientHeight - (c + h))
          , y = Ai(u)
          , p = {
...
function lx(e) {
    ...
    , [])
      ...
      , Q = w.useCallback( () => {
        ...
        sx(k.current, b.current, T).then(N => {
            const L = {
                ...N,
                isPositioned: I.current !== !1
            };
            A.current && !bs(R.current, L) && (R.current = L,
            li.flushSync( () => {
                f(L)
            }
            ))
...
var oc = "PopperContent"
  ...
  , Lm = w.forwardRef( (e, t) => {
    ...
    const {__scopePopper: n, side: r="bottom", sideOffset: o=0, align: i="center", alignOffset: s=0, arrowPadding: l=0, avoidCollisions: a=!0, collisionBoundary: u=[], collisionPadding: c=0, sticky: f="partial", hideWhenDetached: h=!1, updatePositionStrategy: d="optimized", onPlaced: x, ...v} = e
      ...
      , {refs: A, floatingStyles: q, placement: $, isPositioned: H, middlewareData: T} = lx({
        strategy: "fixed",
        placement: M,
        whileElementsMounted: (...Jt) => Jw(...Jt, {
        ...
        middleware: [ux({
            ...
            ...Q,
            apply: ({elements: Jt, rects: ci, availableWidth: ol, availableHeight: di}) => {
    ...
    S.jsx("div", {
        ...
        style: {
            ...
            zIndex: he,
            "--radix-popper-transform-origin": [(Fn = T.transformOrigin) == null ? void 0 : Fn.x, (Zt = T.transformOrigin) == null ? void 0 : Zt.y].join(" "),
...
var kx = Am
  ...
  , [Nx,$m] = Xs(Fm)
  , Um = e => {
    const {__scopeTooltip: t, delayDuration: n=Tx, skipDelayDuration: r=300, disableHoverableContent: o=!1, children: i} = e
      , s = w.useRef(!0)
      , l = w.useRef(!1)
      , a = w.useRef(0);
    return w.useEffect( () => {
...
var jx = "TooltipPortal"
  ...
  , Jr = "TooltipContent"
  , Vm = w.forwardRef( (e, t) => {
    const n = Ox(Jr, e.__scopeTooltip)
      , {forceMount: r=n.forceMount, side: o="top", ...i} = e
      , s = Zs(Jr, e.__scopeTooltip);
    return S.jsx(Ku, {
        present: r || s.open,
        children: s.disableHoverableContent ? S.jsx(Hm, {
            side: o,
            ...i,
            ref: t
        }) : S.jsx(_x, {
    ...
    , [f])
      , d = w.useCallback( (x, v) => {
        const y = x.currentTarget
          ...
          , p = Ix(m, y.getBoundingClientRect())
          , g = zx(m, p)
          , E = Fx(v.getBoundingClientRect())
          , C = Ux([...g, ...E]);
        l(C),
        f(!0)
    }
...
var Wm = "TooltipArrow"
  , Dx = w.forwardRef( (e, t) => {
    const {__scopeTooltip: n, ...r} = e
      , o = ic(n);
    return Ax(Wm, n).isInside ? null : S.jsx(Px, {
        ...o,
        ...r,
        ref: t
    })
...
var Vx = Um
  , Qm = Vm;
const Hx = Vx
  , Wx = w.forwardRef( ({className: e, sideOffset: t=4, ...n}, r) => S.jsx(Qm, {
    ref: r,
    sideOffset: t,
    className: At("z-50 overflow-hidden rounded-md border bg-popover px-3 py-1.5 text-sm text-popover-foreground shadow-md animate-in fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2", e),
    ...n
}));
Wx.displayName = Qm.displayName;
var Js = class {
    constructor() {
...
function Xx(e, t, n) {
    return typeof n.structuralSharing == "function" ? n.structuralSharing(e, t) : n.structuralSharing !== !1 ? Km(e, t) : t
}
function Zx(e, t, n=0) {
    const r = [...e, t];
...
var Kn, fn, Ir, af, eS = (af = class extends Js {
    constructor() {
        super();
        Z(this, Kn);
        Z(this, fn);
    ...
    onSubscribe() {
        P(this, fn) || this.setEventListener(P(this, Ir))
    }
    onUnsubscribe() {
        var t;
...
fn = new WeakMap,
Ir = new WeakMap,
af), Gm = new eS, zr, pn, Fr, uf, tS = (uf = class extends Js {
    constructor() {
        super();
        Z(this, zr, !0);
        Z(this, pn);
...
function Zm(e) {
    ...
    const i = nS()
      ...
      , u = () => Gm.isFocused() && (e.networkMode === "always" || Ps.isOnline()) && e.canRun()
...
var Me = iS(), Yn, cf, Jm = (cf = class {
    ...
    scheduleGc() {
        this.clearGcTimeout(),
        Kx(this.gcTime) && B(this, Yn, setTimeout( () => {
            this.optionalRemove()
        }
        , this.gcTime))
    }
...
,
Yn = new WeakMap,
cf), $r, Gn, tt, qn, Ne, ei, Xn, mt, It, df, sS = (df = class extends Jm {
    constructor(t) {
        super();
        Z(this, mt);
        Z(this, $r);
    ...
    setData(t, n) {
        const r = Xx(this.state.data, t, this.options);
    ...
    isStaleByTime(t=0) {
        return this.state.data === void 0 ? !0 : t === "static" ? !1 : this.state.isInvalidated ? !0 : !Yx(this.state.dataUpdatedAt, t)
    }
    onFocus() {
        var n;
    ...
    fetch(t, n) {
        ...
        (this.state.fetchStatus === "idle" || this.state.fetchMeta !== ((c = l.fetchOptions) == null ? void 0 : c.meta)) && be(this, mt, It).call(this, {
            type: "fetch",
            meta: (f = l.fetchOptions) == null ? void 0 : f.meta
        });
        const a = h => {
            var d, x, v, y;
            Ul(h) && h.silent || be(this, mt, It).call(this, {
                type: "error",
                error: h
            }),
            Ul(h) || ((x = (d = P(this, tt).config).onError) == null || x.call(d, h, this),
        ...
        return B(this, Ne, Zm({
            ...
            onSuccess: h => {
                ...
                (x = (d = P(this, tt).config).onSuccess) == null || x.call(d, h, this),
...
var Tt, ff, uS = (ff = class extends Js {
    constructor(t={}) {
        super();
        Z(this, Tt);
        this.config = t,
...
,
Tt = new WeakMap,
ff), Nt, Oe, Zn, Rt, ln, pf, cS = (pf = class extends Jm {
    constructor(t) {
        super();
        Z(this, Rt);
        Z(this, Nt);
    ...
    optionalRemove() {
        P(this, Nt).length || (this.state.status === "pending" ? this.scheduleGc() : P(this, Oe).remove(this))
    }
    continue() {
        var t;
    ...
    async execute(t) {
        ...
        try {
            if (r)
                ...
                await ((s = (i = P(this, Oe).config).onMutate) == null ? void 0 : s.call(i, t, this));
                const _ = await ((a = (l = this.options).onMutate) == null ? void 0 : a.call(l, t));
                _ !== this.state.context && be(this, Rt, ln).call(this, {
                    type: "pending",
                    context: _,
                    variables: t,
                    isPaused: o
            ...
            const M = await P(this, Zn).start();
            return await ((c = (u = P(this, Oe).config).onSuccess) == null ? void 0 : c.call(u, M, t, this.state.context, this)),
            await ((h = (f = this.options).onSuccess) == null ? void 0 : h.call(f, M, t, this.state.context)),
            await ((x = (d = P(this, Oe).config).onSettled) == null ? void 0 : x.call(d, M, null, this.state.variables, this.state.context, this)),
            await ((y = (v = this.options).onSettled) == null ? void 0 : y.call(v, M, null, t, this.state.context)),
            be(this, Rt, ln).call(this, {
                type: "success",
                data: M
            }),
            ...
            try {
                throw await ((p = (m = P(this, Oe).config).onError) == null ? void 0 : p.call(m, M, t, this.state.context, this)),
                await ((E = (g = this.options).onError) == null ? void 0 : E.call(g, M, t, this.state.context)),
                await ((k = (C = P(this, Oe).config).onSettled) == null ? void 0 : k.call(C, void 0, M, this.state.variables, this.state.context, this)),
                await ((R = (b = this.options).onSettled) == null ? void 0 : R.call(b, void 0, M, t, this.state.context)),
                M
            } finally {
                be(this, Rt, ln).call(this, {
                    type: "error",
...
var $t, gt, ti, hf, fS = (hf = class extends Js {
    constructor(t={}) {
        super();
        Z(this, $t);
        Z(this, gt);
...
var de, hn, mn, Ur, Br, gn, Vr, Hr, mf, hS = (mf = class {
    constructor(e={}) {
        Z(this, de);
        Z(this, hn);
        Z(this, mn);
        ...
        Z(this, Vr);
        Z(this, Hr);
        B(this, de, e.queryCache || new uS),
        B(this, hn, e.mutationCache || new fS),
    ...
    mount() {
        pi(this, gn)._++,
        P(this, gn) === 1 && (B(this, Vr, Gm.subscribe(async e => {
            e && (await this.resumePausedMutations(),
            P(this, de).onFocus())
        }
        )),
        B(this, Hr, Ps.subscribe(async e => {
            e && (await this.resumePausedMutations(),
            P(this, de).onOnline())
        }
        )))
    ...
    unmount() {
        var e, t;
        pi(this, gn)._--,
        P(this, gn) === 0 && ((e = P(this, Vr)) == null || e.call(this),
        B(this, Vr, void 0),
    ...
    resumePausedMutations() {
        return Ps.isOnline() ? P(this, hn).resumePausedMutations() : Promise.resolve()
    }
    getQueryCache() {
        return P(this, de)
    }
...
Vr = new WeakMap,
Hr = new WeakMap,
mf), mS = w.createContext(void 0), gS = ({client: e, children: t}) => (w.useEffect( () => (e.mount(),
() => {
    e.unmount()
}
), [e]),
...
function ES(e) {
    e.sort( (t, n) => t.score !== n.score ? n.score - t.score : jS(t.routesMeta.map(r => r.childrenIndex), n.routesMeta.map(r => r.childrenIndex)))
}
const CS = /^:[\w-]+$/
  , kS = 3
  , bS = 2
...
function RS(e, t) {
    let n = e.split("/")
      , r = n.length;
    return n.some(nf) && (r += NS),
    t && (r += bS),
    n.filter(o => !nf(o)).reduce( (o, i) => o + (CS.test(i) ? kS : i === "" ? PS : TS), r)
}
function jS(e, t) {
...
function OS(e, t, n) {
    ...
    for (let l = 0; l < r.length; ++l) {
        ...
        s.push({
            ...
            pathnameBase: AS(Dr([i, f.pathnameBase])),
            route: h
        }),
...
function rf(e, t) {
    ...
    let[n,r] = _S(e.path, e.caseSensitive, e.end)
      , o = t.match(n);
    if (!o)
        return null;
    let i = o[0]
...
function _S(e, t, n) {
    t === void 0 && (t = !1),
    n === void 0 && (n = !0),
    eg(e === "*" || !e.endsWith("*") || e.endsWith("/*"), 'Route path "' + e + '" will be treated as if it were ' + ('"' + e.replace(/\*$/, "/*") + '" because the `*` character must ') + "always follow a `/` in the pattern. To get rid of this warning, " + ('please change the route path to "' + e.replace(/\*$/, "/*") + '".'));
    let r = []
...
function MS(e) {
    try {
        ...
        return eg(!1, 'The URL path "' + e + '" could not be decoded because it is is a malformed URL segment. This is probably due to a bad percent ' + ("encoding (" + t + ").")),
        e
    }
}
function og(e, t) {
...
const IS = w.createContext(null)
  ...
  , lg = w.createContext(null);
function ac() {
    return w.useContext(nl) != null
}
function ag() {
    return ac() || Ve(!1),
    w.useContext(nl).location
}
function FS(e, t) {
    return $S(e, t)
}
function $S(e, t, n, r) {
    ...
    let x = xS(e, {
      ...
      , v = WS(x && x.map(y => Object.assign({}, y, {
...
function US() {
    let e = GS()
      , t = LS(e) ? e.status + " " + e.statusText : e instanceof Error ? e.message : JSON.stringify(e)
...
const BS = w.createElement(US, null);
...
function WS(e, t, n, r) {
    ...
    return s.reduceRight( (c, f, h) => {
        ...
        ;
        return n && (f.route.ErrorBoundary || f.route.errorElement || h === 0) ? w.createElement(VS, {
            location: n.location,
...
function GS() {
    var e;
    let t = w.useContext(lg)
      , n = QS(Ya.UseRouteError)
      , r = YS(Ya.UseRouteError);
...
function XS(e) {
    ...
    , [a, c, f, h, d, x, o]);
    return v == null ? null : w.createElement(sg.Provider, {
        value: u
...
const ug = "/assets/reliance-logo-Hb8N3NM0.png"
  , nE = () => {
    ...
    return S.jsxs("header", {
        className: `fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${e ? "bg-background/95 backdrop-blur shadow-md" : "bg-transparent"}`,
        children: [S.jsxs("div", {
            ...
            children: [S.jsx("a", {
                ...
                children: o.map(i => S.jsx("a", {
                    href: i.href,
                    className: `text-sm font-heading font-semibold tracking-wide uppercase transition-colors ${e ? "text-foreground hover:text-primary" : "text-primary-foreground hover:text-primary-foreground/80"}`,
                    children: i.label
                }, i.href))
            }), S.jsx("button", {
                ...
                children: n ? S.jsx(um, {
                    className: e ? "text-foreground" : "text-primary-foreground"
                }) : S.jsx(t1, {
                    className: e ? "text-foreground" : "text-primary-foreground"
                })
            })]
            ...
            children: o.map(i => S.jsx("a", {
                href: i.href,
                onClick: () => r(!1),
                className: "block py-3 text-sm font-heading font-semibold uppercase text-foreground hover:text-primary",
                children: i.label
            }, i.href))
        })]
    })
}
  , rE = "/assets/hero-construction-DzVz8buQ.jpg"
  , oE = lm("inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0", {
    variants: {
        variant: {
  ...
  , uc = w.forwardRef( ({className: e, variant: t, size: n, asChild: r=!1, ...o}, i) => {
    const s = r ? Zy : "button";
    return S.jsx(s, {
        className: At(oE({
            variant: t,
...
const iE = () => S.jsxs("section", {
    ...
    children: [S.jsxs("div", {
        ...
        children: [S.jsxs("h1", {
            className: "text-4xl md:text-6xl lg:text-7xl font-heading font-extrabold text-primary-foreground leading-tight mb-6 animate-fade-in-up",
            children: ["Building Excellence", S.jsx("br", {}), S.jsx("span", {
            ...
            children: "Delivering reliable, high-quality construction solutions for residential, commercial, and government projects since day one."
        }), S.jsx("div", {
            ...
            children: S.jsx(uc, {
                size: "lg",
                className: "bg-primary hover:bg-primary/90 text-primary-foreground font-heading font-bold text-base px-10 py-6 rounded-sm uppercase tracking-wider",
                asChild: !0,
                children: S.jsx("a", {
                    href: "#contact",
  ...
  , sE = "/assets/about-construction-Mn-LzqzE.jpg"
  , lE = [{
    icon: q0,
        ...
        children: S.jsxs("div", {
            ...
            children: [S.jsxs("div", {
                ...
                children: [S.jsx("img", {
                    ...
                    className: "rounded-sm shadow-lg w-full object-cover aspect-square"
                }), S.jsx("div", {
                    className: "absolute -bottom-4 -right-4 w-24 h-24 bg-primary rounded-sm hidden md:block"
                })]
            }), S.jsxs("div", {
                children: [S.jsx("p", {
                    className: "text-sm font-heading font-bold uppercase tracking-widest text-primary mb-3",
                    children: "About Us"
                }), S.jsx("h2", {
                    className: "text-3xl md:text-4xl font-heading font-extrabold text-foreground mb-6 leading-tight",
                    children: "A Legacy of Quality & Reliability"
                }), S.jsx("p", {
                    className: "text-muted-foreground leading-relaxed mb-8",
                    children: "Reliance Construction Company has built its reputation on dependable craftsmanship, uncompromising safety standards, and delivering projects on time and within budget. From residential builds to large-scale commercial developments, our experienced team brings integrity to every project we undertake."
                }), S.jsx("div", {
                    className: "grid grid-cols-2 gap-6",
                    children: lE.map(e => S.jsxs("div", {
                        className: "flex items-start gap-3",
                        children: [S.jsx("div", {
                            className: "w-10 h-10 rounded-sm bg-primary/10 flex items-center justify-center flex-shrink-0",
  ...
  , uE = [{
    ...
    description: "Custom homes and residential developments built with precision, quality materials, and attention to every detail."
}, {
    icon: Y0,
    title: "Commercial Construction",
    description: "Office buildings, retail spaces, and industrial facilities engineered for durability and modern functionality."
}, {
    icon: o1,
    title: "Renovation & Remodeling",
    description: "Transforming existing structures with expert craftsmanship, from interior remodels to full-scale renovations."
}, {
    icon: G0,
    title: "Project Management",
    description: "End-to-end project oversight ensuring timelines, budgets, and quality benchmarks are met consistently."
}]
  , cE = () => S.jsx("section", {
    id: "services",
    ...
    children: S.jsxs("div", {
        ...
        children: [S.jsxs("div", {
            ...
            children: [S.jsx("p", {
                ...
                className: "text-3xl md:text-4xl font-heading font-extrabold text-foreground",
                children: "What We Do Best"
            })]
        }), S.jsx("div", {
            className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-8",
            children: uE.map(e => S.jsxs("div", {
                className: "bg-card rounded-sm p-8 shadow-sm border border-border hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group",
                children: [S.jsx("div", {
                    className: "w-14 h-14 rounded-sm bg-primary/10 flex items-center justify-center mb-6 group-hover:bg-primary transition-colors duration-300",
                    children: S.jsx(e.icon, {
                        className: "w-7 h-7 text-primary group-hover:text-primary-foreground transition-colors duration-300"
                    })
                }), S.jsx("h3", {
                    className: "text-lg font-heading font-bold text-foreground mb-3",
                    children: e.title
                }), S.jsx("p", {
  ...
  , dE = "/assets/team-ceo-D7SGViGm.jpg"
  , fE = "/assets/team-pm-BDinqeiN.jpg"
  , pE = "/assets/team-engineer-kTszEcix.jpg"
  , hE = "/assets/team-ops-BqARKCt6.jpg"
  , mE = [{
    name: "Robert Harrison",
    role: "Chief Executive Officer",
    image: dE,
    desc: "25+ years leading major construction projects across commercial and government sectors."
}, {
    name: "Sarah Mitchell",
    role: "Project Manager",
    image: fE,
    desc: "Expert in delivering complex projects on time and within budget."
}, {
    name: "David Kowalski",
    role: "Chief Engineer",
    image: pE,
    desc: "Specializes in structural engineering and innovative building solutions."
}, {
    name: "Emily Chen",
    role: "Operations Director",
    image: hE,
    desc: "Streamlines operations to ensure safety, quality, and efficiency on every project."
}]
  , gE = () => S.jsx("section", {
    id: "team",
    ...
    children: S.jsxs("div", {
        ...
        children: [S.jsxs("div", {
            ...
            children: [S.jsx("h2", {
                ...
                children: "Our leadership team brings decades of combined experience in construction, engineering, and project management."
            })]
        }), S.jsx("div", {
            className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8",
            children: mE.map( (e, t) => S.jsxs("div", {
                className: "group bg-card rounded-lg shadow-sm border border-border overflow-hidden hover:shadow-lg transition-shadow duration-300 animate-fade-in-up",
                style: {
  ...
  , vE = "/assets/project-1-ILLe9QNG.jpg"
  , yE = "/assets/project-2-3Df4dRZF.jpg"
  , wE = "/assets/project-3-CYsapFZr.jpg"
  , xE = "/assets/project-4-CWD8-XNe.jpg"
  , SE = "/assets/project-5-JfBy_otj.jpg"
  , EE = "/assets/project-6-BaDg5YWE.jpg"
  , CE = [{
    image: vE,
    title: "Skyline Tower",
    category: "Commercial"
    ...
    children: S.jsxs("div", {
        ...
        children: [S.jsxs("div", {
            ...
            children: [S.jsx("h2", {
                ...
                className: "text-muted-foreground max-w-2xl mx-auto",
                children: "A showcase of our finest work — from towering commercial builds to critical infrastructure projects."
            })]
        }), S.jsx("div", {
            className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6",
            children: CE.map( (e, t) => S.jsxs("div", {
                className: "group relative overflow-hidden rounded-lg shadow-sm border border-border animate-fade-in-up cursor-pointer",
                style: {
                ...
                children: [S.jsx("div", {
                    ...
                    className: "absolute inset-0 bg-gradient-to-t from-secondary/90 via-secondary/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6",
                    children: [S.jsx("span", {
                        className: "text-primary-foreground/70 text-xs font-medium uppercase tracking-widest mb-1",
                        children: e.category
                    }), S.jsx("h3", {
...
const bE = () => {
    ...
    return S.jsx("section", {
        ...
        children: S.jsxs("div", {
            ...
            children: [S.jsxs("div", {
                ...
                className: "grid md:grid-cols-2 gap-12 lg:gap-20 max-w-5xl mx-auto",
                children: [S.jsxs("div", {
                    className: "space-y-8",
                    children: [S.jsx("p", {
                        className: "text-muted-foreground leading-relaxed",
                        children: "Ready to start your next project? Contact us today for a free consultation and quote. Our team is ready to bring your vision to life."
                    }), [{
                        icon: n1,
                        label: "+1 (555) 123-4567"
                    }, {
                        icon: J0,
                        label: "info@relianceconstruction.com"
                    }, {
                        icon: e1,
                        label: "123 Construction Ave, Building City, ST 12345"
                    }].map(o => S.jsxs("div", {
                        className: "flex items-center gap-4",
                        children: [S.jsx("div", {
                            className: "w-12 h-12 rounded-sm bg-primary/10 flex items-center justify-center flex-shrink-0",
                    ...
                    children: [S.jsx(Xa, {
                        ...
                        required: !0,
                        className: "bg-muted border-border rounded-sm h-12"
                    }), S.jsx(Xa, {
                        type: "email",
                        ...
                        required: !0,
                        rows: 5,
                        className: "bg-muted border-border rounded-sm resize-none"
                    }), S.jsx(uc, {
                        type: "submit",
                        size: "lg",
                        className: "w-full bg-primary hover:bg-primary/90 text-primary-foreground font-heading font-bold uppercase tracking-wider rounded-sm",
  ...
  , PE = () => S.jsx("footer", {
    ...
    children: S.jsxs("div", {
        ...
        children: [S.jsx("img", {
            ...
            className: "font-heading font-bold text-lg text-secondary-foreground",
            children: "Reliance Construction Company"
        }), S.jsxs("p", {
  ...
  , TE = () => S.jsxs("main", {
    children: [S.jsx(nE, {}), S.jsx(iE, {}), S.jsx(aE, {}), S.jsx(cE, {}), S.jsx(gE, {}), S.jsx(kE, {}), S.jsx(bE, {}), S.jsx(PE, {})]
})
  , NE = () => {
    const e = ag();
    return w.useEffect( () => {
  ...
  , jE = () => S.jsx(gS, {
    client: RE,
    children: S.jsxs(Hx, {
        children: [S.jsx($1, {}), S.jsx(yw, {}), S.jsx(tE, {
            children: S.jsxs(ZS, {
                children: [S.jsx(Ga, {
                    path: "/",
                    element: S.jsx(TE, {})
...
Oh(document.getElementById("root")).render(S.jsx(jE, {}));
